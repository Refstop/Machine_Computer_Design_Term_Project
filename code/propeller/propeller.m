...
p=[ [-1115,-365,500, 0, 0, 0, 0];
    ...
    [xxx,yyy,zzz-500, 0, 0, 0, 0];
    [xxx,yyy-100,zzz-500, 0, 0, 0, 0];
    [xxx-100,yyy-100,zzz, 0, 0, 0, 0];
    [xxx-100,yyy-200,zzz, 0, 0, 0, 0];
    [xxx,yyy-200,zzz-500, 0, 0, 0, 0];
...
xlabel('x'); ylabel('z');
grid on
sgt = sgtitle('propeller','Color','red')
sgt.FontSize = 20;
